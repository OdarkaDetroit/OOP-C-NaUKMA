...
Time::Time(int h, int m, int s) : _hour(h), _minute(m), _second(s) { normalizeTime(); cout << "Time created!\n"; };

Time::Time(const Time& time) : _hour(time._hour), _minute(time._minute), _second(time._second) { normalizeTime(); cout << "Time created!\n";
};

Time::~Time() { cout << "Time deleted!\n"; return; }
